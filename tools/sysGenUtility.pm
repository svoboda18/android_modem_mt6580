...
# Constants
#****************************************************************************
my $SYSGENUTILITY_VERNO     = " m0.36";
             # m0.36, 2016/08/01, Added MT6750 to SwitchToClonedChip
             # m0.35, 2016/07/28, Support MT6570
             # m0.34, 2013/08/16, Apply aapmc on 72.82.71.92 and future chip's md size
             # m0.33, 2013/08/06, Support to apply adjusting load view and MD size in SLT load
             # m0.32, 2013/08/05, Support MT6592 to adjust load view in SLT load
             # m0.31, 2013/07/25, Support MT6571
             # m0.30, 2013/07/25, Support MT6592
             # m0.29, 2013/04/03, Support autoconfig if it's SLT load
             # m0.28, 2013/03/21, Support GetMD_AlignmentByChip()
             # m0.27, 2013/02/19, Support not to auto-adjust if it's modem only load
             ...
             # m0.22, 2012/12/17, Support MT6572/MT6582
    ...
    my %BB_INTSRAM_tbl =
       (        # $bb => [INTSRAM_CODE_Base, INTSRAM_CODE_Size, INTSRAM_DATA_Base, INTSRAM_DATA_Size]
            ...
            'MT6589_MD1'  => ["0x70000000", "0x00040000", "+0x0",       "0x00040000"],
                'MT6572'  => ["0x70000000", "0x00040000", "+0x0",       "0x00040000"],
                'MT6592'  => ["0x70000000", "0x00040000", "+0x0",       "0x00040000"],
                'MT6571'  => ["0x70000000", "0x00004000", "+0x0",       "0x00002000"],
            'MT6589_MD2'  => ["0x70000000", "0x00002000", "0x70002000", "0x00002000"],
                'MT6580'  => ["0x70000000", "0x00040000", "+0x0",       "0x00040000"],
                'MT6570'  => ["0x70000000", "0x00040000", "+0x0",       "0x00040000"],
       );
