...
{
    UICC_NOT_INIT,
    SIM_CARD_INSIDE,    /* Currently, not used. RFU */
    UICC_USIM_INSIDE,
    UICC_SIM_INSIDE
} uicc_card_type_enum;
...
#define MAX_SUPPORT_ACSGL_DATA_SIZE 2048 /* __CSG_SUPPORT__ */	 
#define MAX_TERMINAL_PROFILE_LEN 20
#define USIM_SUPPORT_EST_LEN   2
/* [MAUI_02620145] mtk01616_100910: configure supported logical channel number here*/
#define UICC_CHANNEL_NUM         1
#define UICC_CHANNEL_MAX_NUM     3 
...
//#define MAX_SIM_ADDR_BCD_LEN      41  define in ps_public_enum.h
#define MAX_SIM_SUB_ADDR_BCD_LEN  41
#define MAX_AT_RESPONESE_LEN 240 //mtk02514_081216
/*__SAT__ end*/
