...
extern kal_bool sim_check_esimpower_subtype_nocard(kal_uint8 sim_ps_id);

extern kal_bool sim_is_card_enabling_ongoing(kal_uint8 sim_ps_id);

extern kal_bool sim_check_esimpower_state_enabled(kal_uint8 sim_ps_id);
