...
typedef enum  {
    L4C_KPALIVE_REQ_IPTYPE_INVALID,
    L4C_KPALIVE_REQ_IPTYPE_IPV4,
    L4C_KPALIVE_REQ_IPTYPE_IPV6
} l4c_kpalive_req_ip_type_e;

typedef struct l4c_kpalive_activate_req_struct {
    kal_uint8 src_id;
    l4c_kpalive_req_ip_type_e     ip_type;
    kal_uint32              cid;
    kal_uint8               src_ipv4_addr[16];
    kal_uint8               dst_ipv4_addr[16];
    kal_uint8               src_ipv6_addr[40];
    kal_uint8               dst_ipv6_addr[40];
    kal_uint8               src_port[6];
    kal_uint8               dst_port[6];
    kal_uint16              time_interval;                         /**< in sec */
    kal_bool                parsing_result;
} l4c_kpalive_activate_req_struct;

typedef struct {
    kal_uint8       src_id;
    kal_uint8       conn_id;
    kal_bool        parsing_result;
} l4c_kpalive_deactivate_req_struct;
