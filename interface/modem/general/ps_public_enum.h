...
/* See tcm_activate_req_state0hdlr() for PCO number counting. */
...
{
   SCRI_REQ_FD  = 0,
   SCRI_REQ_FOP = 1      /* RAU Accept with FOP on */
...
typedef enum {
    NOT_ALLOWED_CSG = 0,
    ALLOWED_CSG = 1,
    OPERATOR_CSG = 2        /* Reserved for Rel9 */
} csg_type_enum;
...
typedef enum {
    SML_STATE_PERMANENT_LOCK        = 0,
    SML_STATE_TEMPORARY_UNLOCK      = 1,
    SML_STATE_PERMANENT_UNLOCK      = 2,
    SML_STATE_PARTIAL_UNLOCK        = 3,
} sml_state_enum;
...
typedef enum {
    ...
    SML_CAT_END_TIME,
    SML_CAT_IMEI,
    SML_CAT_VERIFICATION_CODE,
    SML_CAT_UNLOCK_TIME_COUNTER,
} sml_ctx_enum;
...
/* ============================== ~SM cause ============================== */
 ...
 // SM proprietary cause
 //    
     SM_PROPRIETARY_CAUSE_START = 0x0D00,
     SM_PROPRIETARY_CAUSE_IRAT_TO_LTE_LOCAL_DEACTIVATED                     = SM_PROPRIETARY_CAUSE_START,
     SM_PROPRIETARY_CAUSE_IRAT_TO_LTE_BUT_BEARER_MAP_INACTIVE               = 0X01 + SM_PROPRIETARY_CAUSE_START, // bearer doesn't exit after mapping
     SM_PROPRIETARY_CAUSE_IRAT_TO_LTE_BUT_LTE_BEARER_MAP_FAILED             = 0X02 + SM_PROPRIETARY_CAUSE_START, // bearer mapping failure and local released
     SM_PROPRIETARY_CAUSE_IRAT_TO_LTE_BUT_BEARER_MAP_LOCAL_RELEASE          = 0X03 + SM_PROPRIETARY_CAUSE_START, // bearer local released

     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_CURRENT_STATE_NOT_COMPATIBLE            = 0X11 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_QOS_NOT_REASONALBE                      = 0X12 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_QOS_TRAFFIC_CLASS_NOT_SUPPORTED         = 0X13 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_NO_AVAILABLE_TI                         = 0X14 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_PROCESS_QUEUE_FULL                      = 0X15 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_GPRS_SUSPENDED                          = 0X16 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_NSAPI_INVALID                           = 0X17 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_GPRS_DETACH                             = 0X18 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_GPRS_ATTACH_FAILURE                     = 0X19 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_GEMINI_SM_CONTEXT_MEMORY_OCCUPIED       = 0X1A + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_ACT_REQ_DUE_TO_REACH_RETRY_COUNTER                     = 0X1B + SM_PROPRIETARY_CAUSE_START,

     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_CURRENT_STATE_NOT_COMPATIBLE        = 0X31 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_NO_AVAILABLE_TI                     = 0X32 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_LINKED_NSAPI_INVALID                = 0X33 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_PROCESS_QUEUE_FULL                  = 0X34 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_NOT_SUPPORT_SECONDARY_PDP           = 0X35 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_GPRS_SUSPENDED                      = 0X36 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_GPRS_DETACH                         = 0X37 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_SEC_ACT_REQ_DUE_TO_COMPOSE_TFT_ERROR                   = 0X38 + SM_PROPRIETARY_CAUSE_START,

     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_PROCESS_QUEUE_FULL                      = 0X51 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_GPRS_SUSPENDED                          = 0X52 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_GPRS_DETACH                             = 0X53 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_CURRENT_STATE_NOT_COMPATIBLE            = 0X54 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_GEMINI_SM_CONTEXT_MEMORY_OCCUPIED       = 0X55 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_FIRST_PDP_NOT_SUPPORT_QOS_MODIFY_FROM_UE    = 0X56 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_MODIFY_COLLISION_WITH_NW                = 0X57 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_REACH_RETRY_COUNTER                     = 0X58 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_MOD_REQ_DUE_TO_QOS_NOT_ACCEPTED                        = 0X59 + SM_PROPRIETARY_CAUSE_START,
     
     SM_LOCAL_REJECT_DEACT_REQ_DUE_TO_GEMINI_SM_CONTEXT_MEMORY_OCCUPIED     = 0X71 + SM_PROPRIETARY_CAUSE_START,
     SM_LOCAL_REJECT_DEACT_REQ_DUE_TO_GPRS_DETACH                           = 0X72 + SM_PROPRIETARY_CAUSE_START,
...
/* ============================== TCM cause ============================== */
    ...
    TCM_L4C_ACT_UNEXPECTED_STATE,
    TCM_L4C_ACT_CID_NOT_DEFINED,
    TCM_L4C_ACT_CID_ALREADY_IN_USE,
    TCM_L4C_ACT_UNKONW_APN,
    TCM_L4C_ACT_INVALID_SEC_ACTIVATION,
    ...
    TCM_L4C_MOD_INVALID_PDP_CONTEXT,
    TCM_L4C_MOD_PRESERVED_PDP_CONTEXT,
    TCM_L4C_MOD_TYPE_OR_TFT_CHECK_FAIL,
	...
	TCM_CID_ALREADY_ACTIVATED,
    TCM_CID_IS_NOT_IN_USE,
	TCM_CID_NOT_DEFINE_TFT_QOS,
	TCM_CID_IS_NOT_PRIMARY,
	TCM_TFT_VALIDATION_ERROR,
	TCM_PTI_IS_FULL,
...
typedef enum{
    ...
    PPE_MO_SMS,
    PPE_MT_SMS_CLASS2,
    PPE_MT_SMS_NOT_CLASS2,
    PPE_STK_SMS,
    PPE_QUERY_DATA,
    PPE_END_DATA,
    PPE_SIM_LOCK_ENVELOPE,
    PPE_MO_PS_CALL,
} atci_ppe_proxy_action_enum;
...
/*****************************************************************************
* DESCRIPTION
*   This eunum is defined for Single Binary Platform (SBP) features
...
typedef enum
{
    ...
    SBP_MM_ILL_MS_ME_CAUSE_PS_INVALID_SIM,
    SBP_NO_SUPPORT_A5_3,
    SBP_MM_DISABLE_PREVIOUS_RPLMN_FROM_NVRAM,
    SBP_VIETTEL_3G_BAND_VARIANT_1,

    /* 6th byte */
    SBP_VIETTEL_3G_BAND_VARIANT_2,
