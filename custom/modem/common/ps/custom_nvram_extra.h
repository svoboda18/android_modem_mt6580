...
extern kal_bool sml_Check( sml_cat_enum cat, 
                           ...
                           kal_uint8 source);
#ifdef __TMO_SIM_LOCK__
extern void sml_printkey(t_cust_chl_sym_key *key);
extern void sml_GetVersion(kal_uint8 *version, kal_uint8 source);
extern kal_bool sml_UpdateNwTimeAndCheckTempLock(kal_uint8 source, kal_uint8 nw_time_zone, nw_time_zone_time_struct *nw_time);
extern kal_bool sml_CheckTempUnlock(kal_uint8 source);
extern kal_bool sml_FirstLoad( void *pLid, kal_uint8 source );
extern kal_uint8 *sml_ReconstructBlob( sml_context_struct *pObj, kal_uint32 *pLen );
