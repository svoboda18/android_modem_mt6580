...
#*************************************************************************
# disable auto-add interface/* folder to global include path if it exist *.h 
#*************************************************************************
...
ifneq ($(filter L1S BASIC UDVT,$(TEST_LOAD_TYPE)),)
  COMMINCDIRS    += service/tst/database/unionTag
endif
...
COMPLIST += mtd sys_svc sys_drv sim_driver peripheral usb_driver
...
ifeq ($(strip $(UTRAN_MODE_SUPPORT)),UTRAN_TDD128_MODE)
  COMP_TRACE_DEFS_MODEM   +=    $(strip $(MODEM_FOLDER))/ll1/include/ll1_trc.h
endif
...
COM_DEFS_FOR_MT6589  = MT6589 __HW_DIVIDER__ MT6589_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6571  = MT6571 __HW_DIVIDER__ MT6571_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6572  = MT6572 __HW_DIVIDER__ MT6572_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6582  = MT6582 __HW_DIVIDER__ MT6582_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6592  = MT6592 __HW_DIVIDER__ MT6592_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6580  = MT6580                MT6580_$(strip $(CHIP_VER))
COM_DEFS_FOR_MT6570  = MT6570                MT6570_$(strip $(CHIP_VER)) MT6580 MT6580_$(strip $(CHIP_VER))
...
COM_DEFS_FOR_MT6168_2G_COCLOCK        = MT6168_2G_RF MT6168_2G_EVB
...
COM_DEFS_FOR_MT6166_2G                = MT6166_2G_RF MT6166_2G_EVB
COM_DEFS_FOR_MT6166_2G_TDD            = MT6166_2G_RF MT6166_2G_EVB
COM_DEFS_FOR_MT6166_DEMO_2G           = MT6166_2G_RF
COM_DEFS_FOR_MT6166_DEMO_2G_TDD       = MT6166_2G_RF
COM_DEFS_FOR_MT6166_DEMO_2G_TDD_WS2089 = MT6166_2G_RF
COM_DEFS_FOR_MT6166_2G_82             = MT6166_2G_RF
COM_DEFS_FOR_MT6166_2G_TDD_82         = MT6166_2G_RF
COM_DEFS_FOR_MT6166_DEMO_2G_82        = MT6166_2G_RF
COM_DEFS_FOR_MT6166_DEMO_2G_TDD_82    = MT6166_2G_RF
COM_DEFS_FOR_MT6166_2G_92             = MT6166_2G_RF
COM_DEFS_FOR_MT6166_DEMO_2G_92        = MT6166_2G_RF
COM_DEFS_FOR_MT6165_2G                = MT6165_2G_RF    
COM_DEFS_FOR_MT6166_DEMO_2G_82_CUSTOM = MT6166_2G_RF
COM_DEFS_FOR_MT6166_UMTS_FDD_CUSTOM   = MT6166_RF
...
COM_DEFS_FOR_MT6167_2G_CUSTOM = MT6167_2G_RF MT6167_2G_CUSTOM
COM_DEFS_FOR_MT6167_2G_SKYPA = MT6167_2G_RF MT6167_2G_SKYPA
COM_DEFS_FOR_MT6167_2G_SKYPA_ALTAI_18 = MT6167_2G_RF MT6167_2G_SKYPA_ALTAI_18
COM_DEFS_FOR_MT6167_2G_SKYPA_S5_128 = MT6167_2G_RF MT6167_2G_SKYPA_S5_128
COM_DEFS_FOR_MT6167_2G_ALTAI_18 = MT6167_2G_RF MT6167_2G_ALTAI_18
COM_DEFS_FOR_MT6167_2G_S5_128 = MT6167_2G_RF MT6167_2G_S5_128
COM_DEFS_FOR_MT6166_2G_CUSTOM = MT6166_2G_RF MT6166_2G_CUSTOM
COM_DEFS_FOR_MT6166_2G_TDD_CUSTOM = MT6166_2G_RF MT6166_2G_CUSTOM
COM_DEFS_FOR_MT6166_DEMO_2G_CUSTOM = MT6166_2G_RF MT6166_2G_CUSTOM
COM_DEFS_FOR_MT6166_DEMO_2G_TDD_CUSTOM = MT6166_2G_RF MT6166_2G_CUSTOM
COM_DEFS_FOR_MT6165_2G_CUSTOM = MT6165_2G_RF MT6165_2G_CUSTOM
COM_DEFS_FOR_CUSTOM_MT6280 = MT6280RF_UMTS_FDD_RF
COM_DEFS_FOR_CUSTOM_MT6167 = MT6167_RF CUSTOM_MT6167
...
ifdef PMIC
  ...
  PMIC_MT6320_SUPPORT_PLATFORM = MT6589 MT6582 MT6571 MT6572 MT6592
  ifeq ($(strip $(PMIC)),MT6320)
    ifeq ($(filter $(strip $(PLATFORM)) ,$(PMIC_MT6320_SUPPORT_PLATFORM)),)
      $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support PMIC=$(strip $(PMIC)))
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
  PMIC_MT6323_SUPPORT_PLATFORM = MT6582 MT6571 MT6572 MT6592
  ifeq ($(strip $(PMIC)),MT6323)
    ifeq ($(filter $(strip $(PLATFORM)) ,$(PMIC_MT6323_SUPPORT_PLATFORM)),)
      $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support PMIC=$(strip $(PMIC)))
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
  PMIC_MT6350_SUPPORT_PLATFORM = MT6580 MT6570
  ifeq ($(strip $(PMIC)),MT6350)
    ifeq ($(filter $(strip $(PLATFORM)) ,$(PMIC_MT6350_SUPPORT_PLATFORM)),)
      $(warning ERROR: PLATFORM $(strip $(PLATFORM)) does not support PMIC=$(strip $(PMIC)))
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
...
NEED_ADD_PMIC_COMPILE_LIST = MT6223PMU MT6238PMU MT6235PMU MT6236PMU MT6573PMU MT6575PMU MT6577PMU MT6305 MT6318 MT6326 MT6253PMU MT6253ELPMU MT6252PMU MT6326_CCCI MT6251PMU MT6276PMU MT6256PMU MT6921PMU MT6329 MT6255PMU MT6922PMU MT6250PMU MT6327 MT6320 MT6323 MT6350
...
ifdef NAND_FLASH_BOOTING
  ifneq ($(strip $(NAND_FLASH_BOOTING)),NONE)
    NAND_FLASH_BOOTING_SUPPORT_PLATFORM = MT6575 MT6280
...
ifeq ($(strip $(USB_SUPPORT)),TRUE)
  USB_SUPPORT_PLATFORM = MT6280 MT6575 MT6577 MT6589 MT6571 MT6572 MT6582 MT6592 MT6571 MT6580 MT6570
...
BROM_USB_DOWNLOAD_SUPPORT_PLATFORM = MT6280
...
ifdef USB_DOWNLOAD_IN_BL
  ifneq ($(strip $(USB_DOWNLOAD_IN_BL)),NONE)
    ifeq ($(strip $(USB_SUPPORT)),TRUE)
      USB_DOWNLOAD_SUPPORT_PLATFORM = MT6575 MT6280 MT6577
...
ifndef MAX_EXT_PDP_CONTEXT
  ifdef IPV6_PDP_SUPPORT
    ...
    $(warning ERROR: IPV6_PDP_SUPPORT is not defined, please define it as TRUE or FALSE)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
...
ENHANCED_SINGLE_BANK_NOR_FLASH_SUPPORT_SUPPORTED_PLATFORM = MT6280
...
ifdef EDGE_SUPPORT
  ifeq ($(strip $(EDGE_SUPPORT)),TRUE)
    EDGE_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592 MT6580 MT6570
    ...
    L1_EPSK_TX_SUPPORT_RF_MODULE = MT6140D_RF AD6546_RF SKY74137_RF SKY74045_RF MT6256RF_RF MT6162_RF MT6163_2G_RF MT6168_2G_RF MT6280RF_2G_RF MT6167_2G_RF MT6166_2G_RF MT6165_2G_RF MT6580RF_2G_RF MT6570RF_2G_RF 
...
ifdef USB_HS_SUPPORT
  ifeq ($(strip $(USB_HS_SUPPORT)),TRUE)
     ifneq ($(strip $(USB_SUPPORT)),TRUE)
       ...
       USB_HS_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592 MT6571 MT6580 MT6570
...
ifeq ($(strip $(AMRWB_LINK_SUPPORT)),TRUE)
  AMRWB_LINK_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592 MT6580 MT6570
...
CENTRALIZED_SLEEP_MANAGER_PLATFORM = MT6575 MT6280 MT6577 MT6589 MT6571 MT6572 MT6582 MT6571 MT6592 MT6580 MT6570
...
ifdef SWLA_SELFSPACE_SUPPORT
  ifeq ($(strip $(SWLA_SELFSPACE_SUPPORT)),TRUE)
    COM_DEFS  = __SWLA_SELFSPACE_ENABLE__
  endif
endif
...
MULTI_LNA_MODE_CALIBRATION_SUPPORT_PLATFORM = MT6575 MT6280 MT6577 MT6589 MT6582 MT6592 MT6571 MT6580 MT6570
...
#Turn on while we need secure code on non SV5 and SV5X platform
ifneq ($(filter $(strip $(PLATFORM)),$(SSS_ENABLE_PLATFORM)),)
    COM_DEFS += __SSS_LIB_ENABLE__ \
                __DIRECT_AP_SEJ_B2C__
endif
...
CR4_PLATFORM = TK6280 MT6280 MT6571 MT6572 MT6582 MT6592 MT6580 MT6570
ifdef PLATFORM
...
ifdef 2G_3SECTION_TEMPERATURE_COMP
  ifeq ($(strip $(2G_3SECTION_TEMPERATURE_COMP)),TRUE)
    COM_DEFS += __2G_3SECTION_TEMPERATURE_COMP__
  endif
endif
...
2G_TX_POWER_CONTROL_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592 MT6580 MT6570
...
ifeq ($(strip $(GERAN_RELEASE_SUPPORT)),GERAN_R7_SUPPORT)
    COM_DEFS    +=   __R99__ __GERAN_R4__ __REL4__ __GERAN_R5__ __REL5__ __GERAN_R6__ __REL6__ __USIM_SUPPORT__ __FDD_REDIRECTION__ __NEW_TBF_ARCH__ __REMOVE_FA__ __MAC_NEW_ARCH__ __GERAN_R7__ __REL7__
endif

ifeq ($(strip $(GERAN_RELEASE_SUPPORT)),GERAN_R8_SUPPORT)
    COM_DEFS    +=   __R99__ __GERAN_R4__ __REL4__  __GERAN_R5__ __REL5__  __GERAN_R6__  __REL6__ __USIM_SUPPORT__ __FDD_REDIRECTION__ __NEW_TBF_ARCH__ __REMOVE_FA__ __MAC_NEW_ARCH__ __GERAN_R7__ __REL7__ __GERAN_R8__ __REL8__
endif
...
ifeq ($(strip $(UMTS_RELEASE_SUPPORT)),UMTS_R8_SUPPORT)
  COM_DEFS    +=  __UMTS_R4__ __UMTS_R5__ __REL4__ __REL5__ __UMTS_R6__ __REL6__ __UMTS_R7__ __REL7__ __UMTS_R8__ __REL8__ __FDD_REDIRECTION__ \
                  __PPACR_SUPPORT__ __HSDPA_2MS_DATA_IND__ __HSDPA_2MS_DATA_IND_LATENCY_IMPROVE__
  ifeq ($(strip $(HSDPA_SUPPORT)),TRUE)
...
ifeq ($(strip $(DATA_CARD_SPEECH)),TRUE)
  DATA_CARD_SUPPORT_PLATFORM = MT6280
...
# define MT6306 switch controller
...
ifneq ($(strip $(CUSTOM_RELEASE)),TRUE)
  ifneq ($(filter 3 4 ,$(GEMINI)),)
    ifeq ($(filter TRUE,$(SIM_SWTICH_CONTROLLER_MT6306)),)
      ifeq ($(filter TRUE,$(SIM_SWTICH_CONTROLLER_MT6302)),)
...
COMPLIST += sys_svc_sec sleep_drv
...
ifdef MOBILE_BROADBAND
  ifeq ($(strip $(MOBILE_BROADBAND)),MBIM)
    ifeq ($(filter L1S BASIC UDVT,$(TEST_LOAD_TYPE)),)
      COM_DEFS     += __NDIS_SUPPORT__ __MBIM_SUPPORT__ __ECM_SUPPORT__
      COMPLIST     += ups
      ifeq ($(filter cmux,$(COMPLIST)),)
        COMPLIST     += cmux
      endif
...
NEED_BUILD_TDD_DRV = TRUE
ifeq ($(filter tdd_drv,$(strip $(REL_MTK_COMP))),)
  ifeq ($(filter tdd_drv,$(strip $(REL_SRC_COMP))),)
    NEED_BUILD_TDD_DRV = FLASE
  endif
endif

ifeq ($(strip $(NEED_BUILD_TDD_DRV)),TRUE)
  COMPLIST += tdd_drv
endif
...
DUAL_TALK_SUPPORT_PLATFORM = MT6589
ifdef MDSYS
  ifeq ($(strip $(MDSYS)),MD1)
    COM_DEFS += __MD1__
    else
...
ifdef MDSYS
  ifeq ($(strip $(DUALTALK)),TRUE)
    COM_DEFS    += __MD_DUALTALK_TURNON__
  endif
endif

COMBO_MEMORY_SUPPORT_PLATFOMR = MT6280
ifdef COMBO_MEMORY_SUPPORT
  ifeq ($(strip $(COMBO_MEMORY_SUPPORT)),TRUE)
    ifeq ($(filter $(PLATFORM), $(strip $(COMBO_MEMORY_SUPPORT_PLATFOMR))),)
      $(warning ERROR: COMBO_MEMORY_SUPPORT = TRUE just can be supported on $(COMBO_MEMORY_SUPPORT_PLATFOMR).)
      DEPENDENCY_CONFLICT = TRUE
    endif
  endif
endif
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6280 MT6589 MT6571 MT6572 MT6582 MT6571 MT6592 MT6580 MT6570
QUERY_32K_CRYSTAL_FROM_MD_PLATFORM = MT6280
QUERY_32K_CRYSTAL_FROM_AP_PLATFORM = MT6589 MT6571 MT6572 MT6582 MT6571 MT6592 MT6580 MT6570
ifdef 32K_XOSC_REMOVE
  ifeq ($(strip $(32K_XOSC_REMOVE)), TRUE)
    ifeq ($(filter $(32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM), $(strip $(PLATFORM))),)
      DEPENDENCY_CONFILICT = TRUE
...
ifneq ($(filter MT6592 MT6571,$(strip $(PLATFORM))),)
  ifeq ($(strip $(L1_LOCK_AFCDAC_AT_STARTUP_SUPPORT)), FALSE)
    $(warning ERROR: L1_LOCK_AFCDAC_AT_STARTUP_SUPPORT only can be enabled when PLATFORM = MT6592 or MT6571)
    DEPENDENCY_CONFLICT = TRUE
  endif
endif
...
ifdef SSDVT_TEST
  ifeq ($(strip $(SSDVT_TEST)),TRUE)
    COMPLIST     += ssdvt
    COM_DEFS     += __SSDVT_TEST__
    ifeq ($(strip $(PRELIMINARY_TEST)),TRUE)
      COM_DEFS     += __PRETEST_IN_BOOTARM_S__
    endif
  endif
endif

ifdef L1_COCLK_REQUIREMENT_CHECK_SUPPORT 
  ifeq ($(strip $(L1_COCLK_REQUIREMENT_CHECK_SUPPORT)), TRUE)
    COM_DEFS += __L1_COCLK_REQUIREMENT_CHECK_SUPPORT__
  endif
endif

ifeq ($(strip $(ACC_NC_AFC_DB_UPDATE_SUPPORT)),TRUE)
  COM_DEFS    += __ACC_NC_AFC_DB_UPDATE_SUPPORT__
endif
...
ifeq ($(strip $(CDMA_USE_MTK_BB_PMU)),TRUE)
  COM_DEFS += __CDMA_USE_MTK_BB_PMU__
endif

ifdef TEE_SECURE_SHAREDMEM_SUPPORT
  ifeq ($(strip $(TEE_SECURE_SHAREDMEM_SUPPORT)),TRUE)
    COM_DEFS    += __TEE_SECURE_SHAREDMEM_SUPPORT__
  endif
endif

ifdef RPMB_SECURE_SHAREDMEM_SUPPORT
  ifeq ($(strip $(RPMB_SECURE_SHAREDMEM_SUPPORT)),TRUE)
    COM_DEFS    += __RPMB_SECURE_SHAREDMEM_SUPPORT__
  endif
endif
...
ifdef 3G_MT6166_FIVE_BANDINDICATOR_SUPPORT
  ifeq ($(strip $(3G_MT6166_FIVE_BANDINDICATOR_SUPPORT)), TRUE)
    COM_DEFS += __3G_MT6166_FIVE_BANDINDICATOR_SUPPORT__
  endif
endif
...
ifdef DCO_SCA_MONITOR
  ifeq ($(strip $(DCO_SCA_MONITOR)),TRUE)
    COM_DEFS += __DCO_SCA_MONITOR__
  endif
endif

ifdef MIPI_SUPPORT
  ifeq ($(strip $(MIPI_SUPPORT)), TRUE)
   COM_DEFS += __3G_MIPI_SUPPORT__
   COM_DEFS += __2G_MIPI_SUPPORT__
  endif
endif

ifdef 3G_BAND5_BAND6_COMBINED
  ifeq ($(strip $(3G_BAND5_BAND6_COMBINED)), TRUE)
    COM_DEFS += __3G_BAND5_BAND6_COMBINED__
  endif
endif
...
ifdef 3G_FHC_RX_HW_MODE
  ifeq ($(strip $(3G_FHC_RX_HW_MODE)), TRUE)
    COM_DEFS += __3G_FHC_RX_HW_MODE__
  endif
endif

ifdef OPTIMIZED_AFC_INIT_FLOW_SUPPORT
  ifeq ($(strip $(OPTIMIZED_AFC_INIT_FLOW_SUPPORT)),TRUE)
    COM_DEFS += __OPTIMIZED_AFC_INIT_FLOW_SUPPORT__
  endif
endif