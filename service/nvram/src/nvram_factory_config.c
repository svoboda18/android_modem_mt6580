...
#else
static kal_uint8 const NVRAM_EF_IMEI_ENCODED[] = {
	/* IMEI 1 */
	0x53, 0x46, 0x64, 0x70, 0x84, 0x40, 0x55, 0x05, /* svn */ 0x00, /* pad */ 0x00,
	/* IMEI 2 */
	0x53, 0x46, 0x64, 0x70, 0x84, 0x40, 0x65, 0x03, 0x00, 0x00
};
#endif
...
/* under construction !*/
...

    {
        ...
        NVRAM_NORMAL(NVRAM_EF_IMEI_ENCODED),
    #ifdef __NVRAM_OTP__
