...
typedef struct {
    ...
    kal_uint8 encrypted_key[SML_MAX_ENCRYPTED_KEY_LENGTH];
...
typedef struct {
    ...
    l4c_source_id_enum src_id;
    kal_uint16 slb_len;
    kal_uint8 slb[SML_MAX_SLB_SIZE];
...
typedef struct {
    ...
    l4c_source_id_enum src_id;
    kal_bool result;
    kal_uint8 version[SML_SIZE_OF_VERSION];
...
typedef struct {
    ...
    kal_uint8 num;
    kal_uint8 sim_plmn_gid[SML_SIZE_OF_MCC_MNC+SML_SIZE_OF_GID];
