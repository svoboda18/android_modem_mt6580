...
extern kal_bool l4c_sat_envelope_req(kal_uint8 src_id, kal_uint8 length, kal_uint8 *envelope_data);
...
extern kal_bool l4c_sim_ap_simpower_req(kal_uint8 src_id,kal_uint8 sim_power_mode);
