...
extern void em_send_msg_to_ps(msg_type msg_id, module_type dest_mod_id, local_para_struct *pLocal);
...
kal_bool l4c_ekalive_activate_req(kal_uint8 src_id, l4c_kpalive_activate_req_struct *param);
kal_bool l4c_ekalive_deactivate_req(kal_uint8 src_id, l4c_kpalive_deactivate_req_struct *param1);
void l4c_ups_kpalive_activate_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
void l4c_ups_kpalive_deactivate_cnf_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);
