 ...
 *
 * 11 20 2020 shrikant.nandagawali
 * [MOLY00586463] [Rainier][R0][BSP+]in the setting CMCC card register network but icon shows that it does not camp on the network
 * .
 *
...
typedef struct
{
   ...
   kal_char gpioPinNameString[L1D_CUSTOM_GPIO_PIN_NAME_STRING_LENGTH];
...
extern kal_int32 IPC_RPC_ADC_GetChannelNumber( kal_uint8 *ChannelName, kal_uint32 ChannelNameLength, kal_uint32 *ChannelNumber );
      #if IS_CHIP_MT6572
extern kal_int32 IPC_RPC_GPIO_GetValue( kal_uint32 GPIONumber, kal_uint32 *GPIOValue );
extern kal_int32 IPC_RPC_ADC_GetValue( kal_uint32 ADCNumber, kal_uint32 *ADCValue );
      #endif
      #if L1D_CUSTOM_MEMORY_DATA_ENABLE
