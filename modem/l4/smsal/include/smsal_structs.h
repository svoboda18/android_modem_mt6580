...
{  
   ...
   kal_uint8                     cbmir_num;   
   kal_uint8                     dcs_num;
   kal_uint8                     cbmir_me_num;  
   kal_uint8                     cbmir_sim_num;  
...
typedef struct
{
   ...
   peer_buff_struct                      *peer_buff_ptr;
    ...
    kal_uint8                            cbmir_me_num;  /*This is used to store the number of valid MI ranges present in the NVRAM*/
    kal_uint8                            cbmir_sim_num; /*This is used to store the number of valid MI ranges present in the SIM*/
} smsal_cb_struct;
#endif
