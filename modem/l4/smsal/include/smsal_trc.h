...
BEGIN_TRACE_MAP(MOD_SMSAL)
   ...
   TRC_MSG(FUNC_CPHS_VM_IND, "SMSAL: cphs voicemail indicationi")
   ...
   TRC_MSG(FUNC_SMSAL_CB_GS_CHANGE_IND_HANDLER, "CB(SMSAL): enter smsal_cb_gs_change_ind_handler")
   ...
   TRC_MSG(SMSAL_CNMA_EXE, "SMSAL: cnmi_id=%d mode=%d")
	...
	TRC_MSG(INFO_CB_GET_STATUS,  "CB(SMSAL): smsal_cb_get_status(), smsal_cb_data_ptr, cbmi_num=%d, cbmir_num=%d, dcs_num=%d")
