...
#elif defined (__SLIM_AT__) || defined (__ECALL_PSAP_SUPPORT__)
...
enum
{
        ...
        RMMI_CMUX_CHANNELS_END = (RMMI_CMUX_CHANNELS_START + (CMUX_VP_NUM_FOR_SINGLE_SIM+CMUX_VPEX_NUM_FOR_SINGLE_SIM)*RMMI_MAX_SIM_NUM - 1),
    #else
        ...
        RMMI_USB2_CHANNEL,
    #endif
    #if defined(__AGPS_SUPPORT__)&&(__SMART_PHONE_MODEM__)
...
typedef enum
{
   ...
   RMMI_ERR_LINK_SIM_C_PERSON_PUK_REQUIRED = 154, //Kinki: SIM-ME lock [MAUI_01264994]
    ...
    RMMI_ERR_CARD_TECHNICAL_PROBLEM = 614,
    RMMI_ERR_AT_NOT_ALLOWED_BY_CUSTOMER = 615,
	RMMI_ERR_FORBIDDEN_PLMN = 616,
...
typedef enum
{
    ...
    RMMI_STKCTRL_BIT = 11   /* bit 11 is for +STKCTRL */
} rmmi_einfo_bit_enum;
