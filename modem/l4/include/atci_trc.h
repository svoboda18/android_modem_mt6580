...
BEGIN_TRACE_MAP(MOD_ATCI)
   ...
   TRC_MSG(FUNC_L4C_SMU_READ_SIM_RRSP_ENTRY, "l4c_smu_read_sim_rrsp()")    /*mtk00468 add for CSIM*/
   ...
   TRC_MSG(FUNC_RMMI_ECGREG_HDLR_ENTRY, "rmmi_ecgreg_hdlr()")
   /*CSD_FAX*/
   ...
   TRC_MSG(WARNING_INVALID_MEAS_RESULT_INDEX, "Warning: meas_result_index invalid")
   ...
   /* -------------------------------------------TRACE_GROUP_10, For XXXXXX------------------------------------------ */
    ...
    TRC_MSG(INFO_PPE_ACTION, "PPE ogoing action:%Matci_ppe_proxy_action_enum")
    TRC_MSG(WARNING_PPE_CMD_NOT_ALLOWED, "PPE action already existed: %Matci_ppe_proxy_action_enum")
    TRC_MSG(WARNING_PPE_SRC_NOT_ALLOWED, "PPE src data should not write to UART!")
#endif
