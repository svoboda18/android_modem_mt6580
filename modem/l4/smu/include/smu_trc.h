...
//   TRC_MSG(IS_SIM_REPLACED, "IS_SIM_REPLACED: %02X ")   
   ...
   TRC_MSG(INFO_SML_TEMP_UNLOCK_TIME, "sml_UpdateNwTimeAndCheckTempLock: start: %d, duration: %d, current: %d")
   TRC_MSG(INFO_SML_CHECK_TEMP_UNLOCK, "sml_CheckTempUnlock: sml_seconds_to_expire = %d, duration: %d")
