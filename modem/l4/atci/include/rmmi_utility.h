...
extern kal_bool is_sms_command(kal_uint8 *data, kal_uint8 length);
...
extern void rmmi_convert_syssel_band(kal_uint8 gsm_band, kal_uint32 umts_band, kal_uint32 *band_map);

extern void rmmi_get_syssel_band(kal_uint8 band, 
                                 kal_uint8 *gsm_band, 
                                 kal_uint32 *umts_band);

extern kal_uint8 rmmi_get_registered_act(domain_id_enum domain);
extern void rmmi_set_registered_act(domain_id_enum domain, kal_uint8 act);


#ifdef __PPE_INTERFACE_SUPPORT__
extern kal_bool atci_ppe_proxy_cmd_ind(kal_uint8 type, kal_uint8 action, kal_uint8 src_id, kal_uint8 *cmd_str, kal_uint16 str_len);

extern void atci_ppe_proxy_cmd_rsp_hdlr(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void atci_ppe_proxy_cmd_req(local_para_struct *local_para_ptr, peer_buff_struct *peer_buff_ptr);

extern void l4c_ppe_proxy_cmd_prsp(kal_uint8 type, kal_uint8 action, kal_uint8 src_id, kal_bool result, kal_uint8 *rsp_str, kal_uint16 str_len);

extern void l4c_ppe_proxy_urc_pind(kal_uint8 *data_str, kal_uint16 str_len);
#endif
...
extern kal_bool rmmi_cpbw_write(kal_uint8 src_id, 
                                kal_uint8 storage, 
                                l4c_phb_entry_struct *entry,
                                rtc_format_struct *rtc_ptr);
extern kal_bool rmmi_cpbw_delete(kal_uint8 src_id, kal_uint8 storage, kal_uint16 index);
#endif /* !defined(__ULC_AT__) */
#endif /* __MOD_PHB__ */

extern void atci_write_to_uart_all_src(kal_uint8 current_src, kal_uint8 *buffer, kal_uint16 length);
