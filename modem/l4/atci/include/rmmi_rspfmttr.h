...
extern void rmmi_ccfc_interrogate_rsp_fmttr(kal_uint8 status, kal_uint8 bclass, kal_uint8 timer, kal_uint8 *address);

extern void rmmi_ccwa_interrogate_rsp_fmttr(kal_uint8 status, kal_uint8 bclass);
...
extern void rmmi_clck_interrogate_rsp_fmttr(kal_uint8 status, kal_uint8 bclass);
