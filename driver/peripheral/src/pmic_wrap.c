...
//#define USE_GPT3_RECORD_DURATION
...
#elif defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6582_REG) || defined(DRV_PMIC_WRAP_6571_REG) || defined(DRV_PMIC_WRAP_6580_REG)
#define PMIC_WRAP_TIMEOUT               1280 // APB Bus Latency
#endif
...
#if defined(DRV_PMIC_WRAP_6571_REG)  
#if defined(USE_GPT3_RECORD_DURATION)
...
kal_uint32 DrvPWRAP_Init(void)
{
    ...
    kal_uint32 rdata;
#if defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6571_REG) || defined(DRV_PMIC_WRAP_6580_REG)
    kal_uint32 cg_mask;
    kal_uint32 backup1;
#endif

#if defined(DRV_PMIC_WRAP_6580_REG)
...
#elif defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6571_REG) || defined(DRV_PMIC_WRAP_6580_REG)
...
#if defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6580_REG)    
    rdata = PMIC_WRAP_DRV_Reg32(WDT_SWSYSRST);
...
#endif // End of #if defined(DRV_PMIC_WRAP_6589_REG)
...
//	PMIC_WRAP_DRV_WriteReg32(CLK_CFG_8, 0x01); // Set SPI_CK freq = 69Mhz
    ...
    //###############################
#if (defined(MT6323) || defined(MT6350))
...
kal_uint32 DrvPWRAP_WACS2_NoChk(kal_uint32 write, kal_uint32 adr, kal_uint32 wdata, kal_uint32 *rdata) // No check INIT DONE, for INIT usage
{
    ...
    reg_rdata = PMIC_WRAP_DRV_Reg32(PMIC_WRAP_WACS2_RDATA);
    while (wait_for_wacs_fsm_idle(reg_rdata)) {
        PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_WACS2_VLDCLR, 0x01);
        reg_rdata = PMIC_WRAP_DRV_Reg32(PMIC_WRAP_WACS2_RDATA);
    }
...
kal_uint32 DrvPWRAP_WACS0(kal_uint32 write, kal_uint32 adr, kal_uint32 wdata, kal_uint16 *rdata)
{
    ...
    /* Check FSM for IDLE and Write 1 clear to recover FSM to IDLE */
    reg_rdata = PMIC_WRAP_DRV_Reg32(PMIC_WRAP_WACS0_RDATA);
    while (wait_for_wacs_fsm_idle(reg_rdata)) {
...
kal_uint32 DrvPWRAP_WACS1(kal_uint32 write, kal_uint32 adr, kal_uint32 wdata, kal_uint16 *rdata)
{
    ...
    /* Check FSM for IDLE and Write 1 clear to recover FSM to IDLE */
    reg_rdata = PMIC_WRAP_DRV_Reg32(PMIC_WRAP_WACS1_RDATA);
    while (wait_for_wacs_fsm_idle(reg_rdata)) {
...
#elif (defined(MT6323) || defined(MT6350))
...
//        wdata = rdata & ~(0x8000); // 26Mhz
    ...
    if(regck_sel == PMIC_WRAP_REG_CLOCK_18MHZ) // 6MHz in 6323/6350  => no support ; 18MHz in 6320
    { 
        // 18MHz
#if defined(DRV_PMIC_WRAP_V1)
    ...
    }else if(regck_sel == PMIC_WRAP_REG_CLOCK_36MHZ) // 12MHz in 6323/6350; 36MHz in 6320
    { 
        // 36MHz    
#if defined(DRV_PMIC_WRAP_V1)
