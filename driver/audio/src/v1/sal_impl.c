...
void SALI_Config_SRC(uint8 apptype, bool isWB)
{
   ...
   *DSP_SPH_SFE_CTRL = (v | (*DSP_SPH_SFE_CTRL & 0xE09));
...
void SALI_Init()
{
  ...
  sal_impl.resync_8k = true;//DSP allways supports, real control from L1's gps co-clock feature
	...
	#if (defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571) || defined(MT6290) || defined(MT6595) || defined(MT6752) || defined(MT6580))
	sal_impl.fwe = true;
	...
	*DSP_SPH_DEBUG_ASSERT_CTRL |= 0x0020;
	...
	#if defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6290) || defined(MT6595) || defined(MT6752) || defined(MT6580)
...
void SALI_EPL_GetFrame(Sal_EPL_Frame *eplfrm)
{
	...
	#elif defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6290) || defined(MT6571) || defined(MT6580)
