...
/*************************************************************************
* FUNCTION
*  IPC_RPC_MemoryData_GetValue
*
* DESCRIPTION
*  This function use to handle control channel messages from AP side
*  major information : Query Memory value of specifed data
*
* PARAMETERS
*  MemoryDataNumber - Number of memory data.
*  MemoryDataValue  - ret value.
* RETURNS
*  RPC Status
*
*************************************************************************/
kal_int32 IPC_RPC_MemoryData_GetValue(kal_uint32 MemoryDataNumber, kal_uint32 *MemoryDataValue)
{
	kal_int32 ret;

    ret =  IPC_RPC_Wrapper(IPC_RPC_GPIO_ADC_GET_MEMVALUE_OP, 
                           sizeof(kal_uint32), (void*)&MemoryDataNumber, IPC_RPC_INPUT_TERM_PATTERN,
                           sizeof(kal_uint32), (void*)MemoryDataValue, IPC_RPC_EOF_TERM_PATTERN);
